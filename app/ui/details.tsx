...
export default function Details() {
	return (
		<div className='font-serif text-xs sm:text-sm sm:grid sm:grid-cols-2 sm:gap-x-6 md:my-2 md:mx-4 md:flex md:flex-col'>
			<h2
				className={`${merriweather.className} uppercase bold text-base text-center sm:text-lg sm:col-span-2 md:my-2`}
			>
				The details
			</h2>
			<p className='text-center my-5 sm:col-span-2 md:my-2'>
				Saturday, October 12, 2024 7:00pm
			</p>
			<div className='text-center my-5 sm:col-span-2 md:my-2'>
				<p>Ginger Beef Bistro House Marlborough</p>
				<p>228 28 St SE, Calgary, AB T2A 6J9</p>
			</div>
			<div className='my-5 sm:row-start-4 md:my-4'>
			...
			<div className='my-5 sm:col-span-2 sm:row-span-1 md:my-4'>
